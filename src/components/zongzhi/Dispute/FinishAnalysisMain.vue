<template>
  <div>
    <el-row class="mainRight">
      <el-col :span="24" class="borderBottom">结案分析列表</el-col>
    </el-row>
    <el-row style="padding-left: 30px;padding-top: 20px;background: #fff;">
      <el-col :span="24" style="text-align: left;">
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          <el-form-item label="所属网格:">
            <el-input v-model="formInline.network"  placeholder="请选择"></el-input>
          </el-form-item>
    ...
    >
      ...
      <el-table-column prop="id"  label="案件编号"  min-width="10%"></el-table-column>
      <el-table-column prop="name" label="事件名称"  show-overflow-tooltip  min-width="13%"></el-table-column>
      <el-table-column prop="from" label="来源"  min-width="11%"></el-table-column>
    ...
    <el-row style="background: #fff;padding-bottom:40px;margin-top: 250px;">
      <el-col :span="24">
        <div class="block">
          <el-pagination
